    ...
    >
      <div className={cn.inner}>
        <h2 id="bloggers-title" className={cn.bloggersTitle}>
          <span className={cn.bloggersTitleLine1}>
            {t('landing.bloggers.titleLine1')}
          </span>
          <span className={cn.bloggersTitleLine2}>
            {t('landing.bloggers.titleLine2')}
          </span>
        </h2>
          ...
          {BLOGGER_CARDS.map((card, index) => (
            <article key={index} className={cn.bloggerCard}>
              <div className={cn.bloggerPhoto}>
                <span>{t('landing.bloggers.photoPlaceholder')}</span>
              </div>
              <div className={cn.bloggerMeta}>
                ...
                <p className={cn.bloggerName}>
                  {t('landing.bloggers.nicknamePlaceholder')}
                </p>
                <IconChevronDown
                  size={24}
                  stroke={1.75}
                ...
                <div className={cn.bloggerLinkRow}>
                  <img
                    ...
                    decoding="async"
                  />
                  <p className={cn.bloggerLink}>
                    {t('landing.bloggers.linkPlaceholder')}
                  </p>
                </div>
              </div>
            </article>
