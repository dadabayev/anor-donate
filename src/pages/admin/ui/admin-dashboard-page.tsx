import cn from './admin-dashboard-page.module.css'
    ...
    <section className={cn.page}>
      <div className={cn.column}>
        <header className={cn.header}>
          <div>
            <h1 className={cn.title}>{t('admin.dashboardPage.title')}</h1>
            <p className={cn.subtitle}>{t('admin.dashboardPage.subtitle')}</p>
          </div>
